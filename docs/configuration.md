...
keeps its exact modes on a clean clone. The current set contains 207 files: 171
...
| `wm-niri` | 15 | 1 | 16 |
| `wm-hyprland` | 16 | 1 | 17 |
| `build-foundation` | 1 | 0 | 1 |
| `repository-tools` | 1 | 0 | 1 |
...
- ASUS defaults with all reviewed physical personal modules: 171 targets;
