...
>
> **2026-09-18 复核提醒（重要）**：§4–§9 里带“当前/目前/仍/现状”字样的失败描述多为
> 2026-08-07/08 快照，其中多项已在 §10 标记 `[x]` 修复，并于 2026-09-18 逐条复核代码：
...
> total=226、mappings=302、recipes=15、config 文件 401（2026-09-21 值），以 `./check-extend.sh`
> reconcile 输出为准。
