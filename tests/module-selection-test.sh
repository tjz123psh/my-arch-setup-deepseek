...
assert_contains asus-default 'apply readiness: ready for implemented component actions'
...
assert_contains desktop-default 'module: virtualization state=selected origin=default availability=available'
assert_contains desktop-default 'apply readiness: ready for implemented component actions'
